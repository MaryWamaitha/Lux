...
class Product extends Connection{
	...
	function perfect_gift($rship,$age,$gender,$trait1,$trait2,$trait3,$trait4){
		return $this->fetch("select * from products where tags like '%$rship%' or tags like '%$age%' or tags like '%$gender%' or tags like '%$trait1%'
		or tags like '%$trait2%'  or tags like '%$trait3%'  or tags like '%$trait4%'");
	}
