...
//Product
function add_product_controller($category,$title,$price,$desc){
    // create an instance of the product class
    $product_instance = new Product();
    // call the method from the class
    return $product_instance->add_product($category,$title,$price,$desc);
...
function select_image_controller($image_id){
    // create an instance of the product class
    $product_instance = new Product();
    // call the method from the class
    return $product_instance->select_image($image_id);

}

function update_product_controller($title,$product_id,$category,$price,$desc){
    // create an instance of the product class
    $product_instance = new Product();
    // call the method from the class
    return $product_instance->update_one_product($title,$product_id,$category,$price,$desc);
