...
function add_to_cart_controller($p_id,$qty,$ip_add,$details,$size){
    // create an instance of the category class
    $cart_instance = new Cart();
    // call the method from the class
    return $cart_instance->add_to_cart($p_id,$qty,$ip_add,$details,$size);
...
function add_order_details_controller($order_id, $product_id, $qty,$details,$size){
    //create instance of the cart class
    $cart_instance = new Cart();
    //calls method from cart class
    return $cart_instance->add_order_details($order_id, $product_id, $qty,$details,$size);
}
...
function select_customer_controller($CID){
    //create instance of the cart class
    $cart_instance = new Cart();
    //calls method from cart class
    return $cart_instance->select_customer($CID);
}
